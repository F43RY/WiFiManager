...
const char HTTP_PORTAL_OPTIONS[] PROGMEM  = "<form action=\"/wifi\" method=\"post\"><button>Configure WiFi</button></form><br/><form action=\"/0wifi\" method=\"post\"><button>Configure WiFi (No Scan)</button></form><br/><form action=\"/i\" method=\"post\"><button>Info</button></form><br/><form action=\"/r\" method=\"post\"><button>Reset</button></form>";
